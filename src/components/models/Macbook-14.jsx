...
export default function MacbookModel14(props) {
  ...
  const { nodes, materials, scene } = useGLTF('/product-site-demo/models/macbook-14-transformed.glb');
...
useGLTF.preload('/product-site-demo/models/macbook-14-transformed.glb')
